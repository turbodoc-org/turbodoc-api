/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 2a68d4939caac50ca766f22c8258dd7a)
...
declare namespace Cloudflare {
  ...
  interface DevEnv {
    ...
    BOOKMARK_WORKFLOW: Workflow<
      Parameters<import("./dist/index").BookmarkWorkflow["run"]>[0]["payload"]
    >;
  }
  interface PrdEnv {
    EMAILER: SendEmail;
